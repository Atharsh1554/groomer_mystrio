...
import { Search, Navigation, MapPin, Camera } from 'lucide-react';
...
export function SalonMap({ onSalonSelect, onLocationRequest, onFaceRecognitionRequest, detectedGender }: SalonMapProps) {
      ...
      <div className="max-w-md mx-auto lg:max-w-4xl">
        <div className="bg-white min-h-screen flex flex-col lg:bg-background lg:pt-4">
          <div className="bg-white lg:rounded-lg lg:shadow-lg lg:border lg:border-border flex flex-col min-h-screen lg:min-h-[calc(100vh-2rem)]">
            ...
            <div className="p-4 border-b">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-xl">Find Salons Near You</h1>
            ...
            {/* Interactive Map */}
            <div className="h-64 lg:h-80 border-b">
              <InteractiveMap 
